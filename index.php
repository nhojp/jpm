<!-- credits to https://codepen.io/leonam-silva-de-souza/pen/vYowKqP-->
        ...
        <aside class="sidebar " data-sidebar>
            <div class="sidebar-info">
                ...
                <div class="info-content">
                    <h1 class="name" title="Richard Hanrick">JP Manjac</h1>
            ...
            <div class="sidebar-info-more">
                ...
                <ul class="contacts-list">
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <a href="mailto:johnpaulmarmanjac@gmail.com" class="contact-link">johnpaulmarmanjac@gmail.com</a>
                        </div>
                    </li>
                    ...
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <a href="tel:+12133522795" class="contact-link">+639304365359</a>
                        </div>
                    </li>
                    ...
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <time datetime="1982-06-23">June 14, 2003</time>
                        </div>
                    </li>
                    ...
                    <li class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <address>Batangas, Philippines</address>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="social-list">
                    <li class="social-item"><a href="https://www.facebook.com/johnpaulmarmanjac" class="social-link"><ion-icon name="logo-facebook"></ion-icon></a></li>
        ...
        <div class="main-content">
            ...
            <article class="about active" data-page="about">
                ...
                <section class="about-text">
                    <p>I’m an aspiring IT professional, wrapping up my degree in Business Analytics, with a passion for using technology to solve complex problems and create smart solutions.</p>
                    <p>I specialize in building websites that are not only functional and user-friendly but also visually engaging. Through my university projects and hands-on experience in web development, I’ve learned how to bring creative ideas to life while keeping usability at the core. I focus on delivering designs that reflect your brand’s message and identity in a clear, modern, and compelling way creating digital solutions that make processes easier and more efficient.</p>
                </section>
            ...
            <article class="resume " data-page="resume">
                ...
                <section class="timeline">
                    ...
                    <ol class="timeline-list">
                        <li class="timeline-item">
                            <h4 class="h4 timeline-item-title">Batangas State University - TNEU</h4>
                            <span>Bachelor of Science in Information Technology - Business Analytics</span>
                            <span>2021 - 2025</span>
                            <p class="timeline-text">I gained a strong foundation in information technology, data analysis, and business processes. I developed practical skills in web development, database management, and systems analysis, while also learning how to use data to support decision-making. My academic experience taught me how to approach problems analytically, work with modern tech tools, and build digital solutions that improve efficiency and user experience.</p>
                        </li>

                        <li class="timeline-item">
                            <h4 class="h4 timeline-item-title">Immaculate Conception College</h4>
                            <span>Information and Communication Technology</span>
                            <span>2019 - 2021</span>
                            <p class="timeline-text">Because of my strong interest in computers, I took the opportunity to learn the basics during senior high school. This included understanding how computer systems work, exploring software applications, and expanding my foundational knowledge, which prepared me for my college studies in IT.</p>
                        </li>
                    </ol>
                </section>
                ...
                <section class="timeline">
                    ...
                    <ol class="timeline-list">
                        <li class="timeline-item">
                            <h4 class="h4 timeline-item-title">IT Intern</h4>
                            <span>South Luzon Thermal Energy Corporation</span>
                            <span>February 2025 - May 2025  </span>
                            <p class="timeline-text">As an IT Intern, I provided technical support to employees, resolving a wide range of technology-related concerns to ensure smooth operations across all departments. I also played a key role in managing and analyzing data within the Plant Performance Office, assisting in generating valuable insights to improve operational efficiency. I practiced programming in PHP, TypeScript, JavaScript, and various frameworks such as Laravel, Bootstrap, and Tailwind, gaining hands-on experience with these technologies. Additionally, I supported network configuration and troubleshooting efforts to maintain a stable and reliable IT infrastructure. I was also responsible for assisting with the company’s IT procurement process, managing purchase requests and orders for essential technology equipment such as PCs, laptops, and peripherals to support the day-to-day needs of the office.</p>
                        </li>
                    </ol>
                </section>
